...
export class AsaStakingContractClient {
  ...
  state = {
    ...
    global: {
      ...
      /**
       * Get the current value of the precision key in global state
       */
      precision: async (): Promise<bigint | undefined> => { return (await this.appClient.state.global.getValue("precision")) as bigint | undefined },
    },
    /**
